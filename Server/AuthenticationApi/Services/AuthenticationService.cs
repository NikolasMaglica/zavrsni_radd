...
public class AuthenticationService : Repository<User>,IAuthenticationService
{
    private readonly UserManager<User> _userManager;
    private readonly IConfiguration _configuration;
  

    public AuthenticationService (UserManager<User> userManager, IConfiguration configuration, AppDbContext appDbContext) : base(appDbContext)
    {
    ...
    public async Task<Result<string>> Login(LoginRequest request)
    {
        ...
        {
            return Result.Fail($"Nije se moguće prijava korisnika {request.Username}");
        }
